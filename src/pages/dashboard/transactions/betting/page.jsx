import { BettingLotteryTransactionsTable } from "../../../../components/betting-lottery-table"
import { Breadcrumb } from "../../../../components/common/Breadcrumb"

export default function bettingAndLotteryData() {
  return (
    <>
      <Breadcrumb
        items={[
      ...
      />
      <BettingLotteryTransactionsTable />
    </>
  )
}