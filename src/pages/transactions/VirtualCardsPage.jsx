    ...
    <>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Review and manage virtual card usage and top-ups.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            ...
            <TableBody>
              {virtualCardTransactions.map((txn) => (
                <TableRow key={txn.id}>
                  <TableCell>{txn.id}</TableCell>
                  <TableCell>{txn.cardholder}</TableCell>
                  <TableCell>{txn.cardNumber}</TableCell>
      ...
      <Dialog open={isDetailsOpen} onOpenChange={setIsDetailsOpen}>
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Full details of transaction <strong>{selectedTransaction?.id}</strong>.
            </DialogDescription>
          </DialogHeader>
          {selectedTransaction && (
            <div className="grid gap-4 py-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div><h3 className="font-medium text-sm">Cardholder</h3><p>{selectedTransaction.cardholder}</p></div>
                <div><h3 className="font-medium text-sm">Card Number</h3><p>{selectedTransaction.cardNumber}</p></div>
