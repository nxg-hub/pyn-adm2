...
export default function AirtimeAndDataPage() {
    ...
    <>
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage purchases and receipts for airtime and data transactions.</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
            ...
            <TableBody>
              {airtimeDataTransactions.map((txn) => (
                <TableRow key={txn.id}>
