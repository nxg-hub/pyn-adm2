...
import LoanDetails from "./pages/transactions/LoanDetails.jsx";
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route
          ...
          />
          <Route
            path="dashboard/users/unsuspended"
            element={<UnsuspendedAccounts />}
          />
          ...
          <Route
            path="dashboard/transactions/loan/details"
            element={<LoanDetails />}
          />
          <Route
